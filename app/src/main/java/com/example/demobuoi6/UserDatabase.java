...
import static com.example.demobuoi6.UserDatabase.DATABASE_VERSION;

@SuppressLint("RestrictedApi")
@Database(entities = {UserEntity.class,AddressEntity.class,PetEntity.class}, version = DATABASE_VERSION,
        autoMigrations = {
                @AutoMigration (
                        from = 1,
                        to = 2,
